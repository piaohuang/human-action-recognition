...
for label in ['walk1', 'walk2', 'stand1','stand2', 'test1','test2','test3']:
    input_file = label+'.npy'
    keypoints_sequence = np.load(os.path.join(root_path,'features', input_file))
    print(input_file, keypoints_sequence.shape, np.max(keypoints_sequence), np.min(keypoints_sequence))
